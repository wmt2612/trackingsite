...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Base64 Tool</h4>
                <p class="card-title-desc">Encrypt</p>
                <form method="GET" action="{{ route('tools.base64') }}" class="form-group">
                    <div style="width: 80%">
                        <div class="row">
                            <div class="col-md-2">
                                <select class="form-select" name="type">
                                    <option value="encrypt" @if(request()->get('type') === 'encrypt') selected @endif>Encrypt</option>
                                    <option value="decrypt"  @if(request()->get('type') === 'decrypt') selected @endif>Decrypt</option>
                                </select>
                            </div>
                            <div class="col-md-6">
